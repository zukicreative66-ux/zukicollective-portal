...
import logoImg from '../assets/images/logo_zuki_1782392716974.svg';
...
// Replace the Unsplash fallbacks with your public-relative paths!
export const logoZuki = "/zukilogo.svg"; 
export const coverZuki = "/cover_zuki.png";
